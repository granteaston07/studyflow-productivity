  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="flex items-center gap-2 gradient-button text-white border-0 hover:scale-105 transition-transform">
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Submit Button */}
          <Button type="submit" className="w-full gradient-button text-white border-0 hover:scale-105 transition-transform">
